...
from .utils import read_text, safe_read_json, read_text_limited, project_root
from .report import resolve_report_llm_cfg, chat_text

# =============================================================================
# Configuration
# =============================================================================

ADVANCED_PROMPT_PATH = os.path.join(project_root(), "prompts", "advanced_metrics.yaml")
...
def ingest_finall_results_comprehensive(finall_dir: str) -> Dict[str, str]:
    ...
    if not os.path.exists(code_path):
        ...
        if os.path.exists(nb_path):
            from .utils import export_notebook_as_py
